...
export default function App() {
  return (
    <div className="bg-body-gray min-h-screen" >
      ...
      <Projects image_url="/assets/images/desktopviewimages/PortoflioCard/Snapshoot4.svg" project_title="Portfolio" project_name="Portfolio" stack="Front end Dev" year="2015" project_description="A sample of my portfolio built with HTML,CSS and JavaScript " stack_1="HTML"stack_2="CSS" stack_3="JavaScript" project_url="https://estherstarr.github.io/personalPortfolio/"/>
